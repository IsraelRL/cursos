...
<head><title>Arouesty | Sistema</title>
    ...
    var mensaje = confirm("¿Seguro que quieres borrar el registro?");
    //Detectamos si el usuario acepto el mensaje
    if (mensaje) {
    location.href="config/eliminarsub.php?id=" + id;
    }
    ...
    function Confirmss(id) {
    //Ingresamos un mensaje a mostrar
    var mensaje = confirm("¿Seguro que quieres borrar el registro?");
    //Detectamos si el usuario acepto el mensaje
    if (mensaje) {
    location.href="config/eliminarsub2.php?id=" + id;
    }
    //Detectamos si el usuario denegó el mensaje
    else {
    ...
    //Detectamos si el usuario acepto el mensaje
    if (mensaje) {
    location.href="config/eliminarvideo.php?id=" + id;
    }
    //Detectamos si el usuario denegó el mensaje
    else {
                        ...
                        <table>
                                                ...
                                                <tbody>
                                                   ...
                                                   <?php  while ($rows = $result1->fetch_assoc()){
                                                             echo "<tr><td><b>" .$rows['nombre']."</b></td></tr>";
                                                              
                                                              $sql4 = "SELECT * FROM subcat WHERE categoria='".$rows['id']."'";
                                                              $result3 = $conn->query($sql4); 
                                                              while ($row2 = $result3->fetch_assoc()){ 
                                                                echo "<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$row2['nombre'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>'; 
                                                                 
                                                                echo  "<td><a href='editarcat.php?id=".$row2['id']."'><button type='button' class='btn btn-default btn-xs'><i class='fa fa-edit'></i>&nbsp;
                                                                            Editar
                                                                        </button></a>&nbsp;&nbsp;&nbsp;
                                                                        
                                                                        <a onclick='Confirms(".$row2['id'].")' href='#'><button type='button' class='btn btn-danger btn-xs'><i class='fa fa-trash-o'></i>&nbsp;
                                                                            Borrar
                                                                        </button></a>&nbsp;&nbsp;&nbsp;&nbsp;";
                                                                        echo  "<a href='nuevovideo.php?id=".$row2['id']."'><button type='button' class='btn btn-xs btn-success filter-submit'>
                                                                            Añadir Video
                                                                        </button></a>". '</td></tr>';

                                                                 $sqlv1 = "SELECT * FROM video WHERE subcategoria='".$row2['id']."'";
                                                                 $resultv2 = $conn->query($sqlv1);

                                                                  while ($rowv1 = $resultv2->fetch_assoc()){ 
                                                                    echo "<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color='#00006F'>".$rowv1['nombre'].'</font></td>'; 
                                                                    echo  "<td><a href='editarvideo.php?id=".$rowv1['id']."'><button type='button' class='btn btn-default btn-xs'><i class='fa fa-edit'></i>&nbsp;
                                                                                Editar
                                                                            </button></a>&nbsp;&nbsp;&nbsp;
                                                                            
                                                                            <a onclick='Confirmv(".$rowv1['id'].")' href='#'><button type='button' class='btn btn-danger btn-xs'><i class='fa fa-trash-o'></i>&nbsp;
                                                                                Borrar
                                                                            </button></a>". '</td></tr>';
                                                                        }
                                                                 ...
                                                                 $sql5 = "SELECT * FROM subsubcat WHERE subcat= '".$row2['id']."'";
                                                                  ...
                                                                  while ($row3 = $result5->fetch_assoc()){
                                                                    if ($row3['nombre'] == "") {
                                                                      ...
                                                                      }else echo "<tr><td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$row3['nombre'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>'; 
                                                                     
                                                                        echo  "<td><a href='editsubsubcat.php?id=".$row3['id']."'><button type='button' class='btn btn-default btn-xs'><i class='fa fa-edit'></i>&nbsp;
                                                                            Editar
                                                                        </button></a>
                                                                        &nbsp;&nbsp;
                                                                        <a onclick='Confirmss(".$row3['id'].")' href='#'><button type='button' class='btn btn-danger btn-xs'><i class='fa fa-trash-o'></i>&nbsp;
                                                                            Borrar
                                                                        </button></a>&nbsp;&nbsp;&nbsp;&nbsp;";
                                                                         echo  "<a href='nuevovideoss.php?id=".$row3['id']."'><button type='button' class='btn btn-xs btn-success filter-submit'>
                                                                            Añadir Video
                                                                        </button></a>". '</td></tr>';

                                                                        $sqlv2 = "SELECT * FROM video WHERE subsub='".$row3['id']."'";
                                                                         $resultv3 = $conn->query($sqlv2);

                                                                          while ($rowv2 = $resultv3->fetch_assoc()){ 
                                                                            echo "<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color='#00006F'>".$rowv2['nombre'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></td>'; 
                                                                            echo  "<td><a href='editarvideo.php?id=".$rowv2['id']."'><button type='button' class='btn btn-default btn-xs'><i class='fa fa-edit'></i>&nbsp;
                                                                                        Editar
                                                                                    </button></a>
                                                                                    &nbsp;&nbsp;
                                                                                    <a onclick='Confirmv(".$rowv2['id'].")' href='#'><button type='button' class='btn btn-danger btn-xs'><i class='fa fa-trash-o'></i>&nbsp;
                                                                                        Borrar
                                                                                    </button></a>". '</td></tr>';
                                                                                }
