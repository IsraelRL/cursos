...
if (isset($_SESSION['name'])){
   ...
   $sql2 = "SELECT * FROM categorias";
    ...
    $result11 = $conn->query($sql2);
    // output data of each row

?>
<!DOCTYPE html>
<html lang="en">
<head><title>Arouesty | Nuevo Usuario</title>
    <meta charset="utf-8">
                    ...
                    <div id="sum_box" class="row mbl">
                        <div class="panel panel-violet">
                            ...
                            <div class="panel-body pan">
                                <form action="config/ingresadato.php" method="post" class="form-validate">
                                    <div class="form-body pal">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group"><label for="first-name">Dirección de correo electrónico:</label>
                                                    <div class="input-icon right"><i class="fa fa-envelope"></i><input type="text" class="form-control required" name="first-name" id="first-name" placeholder="Ponga su Usuario"></div>
                                                </div>
                                            </div>

                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="input-icon right"><label for="last-name">Contrasena:</label><input type="password" minlength="5" class="form-control required" name="contrasena" id="last-name" placeholder="Ingresa tu Contrasena"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="input-icon right"><label for="email-address">Nombre:</label><i class="fa fa-user"></i><input type="text" class="form-control required" name="nombre" id="email-address" placeholder="Ingrese su nombre"></div>
                                                </div>
                                            </div>
                                            <!--<div class="col-md-6">
                                                <div class="form-group"><label for="phone-number">Permisos:</label>
                                                    <?php /* while($ro = $result11->fetch_assoc()) {
                                                             echo "<br><input class='form-control required' type='checkbox' name='cat[]' value='".$ro['id']."'> ".$ro['nombre']."";
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group"><label for="address">Fecha de Inicio</label>
                                                    <div><span class="input-group-addon"><input type="text"  name="pickup" id="f1" class="form-control required required" value="<?php echo date("
                                                    Y-m-d"); ?>" readonly="readonly"/></span></div>
                                                </div>
                                            </div>
