...
<!DOCTYPE html>
<html lang="en">
<head><title>CityCar | Dashboard</title>
    <meta charset="utf-8">
    ...
    <div id="header-topbar-option-demo" class="page-header-topbar">
        <nav id="topbar" role="navigation" style="margin-bottom: 0;" data-step="3" data-intro="&lt;b&gt;Topbar&lt;/b&gt; has other styles with live demo. Go to &lt;b&gt;Layouts-&gt;Header&amp;Topbar&lt;/b&gt; and check it out." class="navbar navbar-default navbar-static-top">
            <div class="navbar-header">
                ...
                <a id="logo" href="home.php" class="navbar-brand"><span class="fa fa-rocket"></span><img class="img-responsive" src="../img/logo.jpg" alt="Car|Rental"></span><span style="display: none" class="logo-text-icon"></a></div>
        ...
        <nav id="sidebar" role="navigation" data-step="2" data-intro="Template has &lt;b&gt;many navigation styles&lt;/b&gt;" data-position="right" class="navbar-default navbar-static-side">
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    </i><span class="menu-title">Reservaciones</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="addreservacion.php"><i class="fa fa-align-left"></i><span class="submenu-title">Nueva Reservacion</span></a></li>
                            <li><a href="verreservacion.php"><i class="fa fa-angle-double-left"></i><span class="submenu-title">Ver Reservaciones</span></a></li>
                        </ul>
                    </li>
                    <li><a href="#"><i class="fa fa-database fa-fw">
                        <div class="icon-bg bg-green"></div>
                    </i><span class="menu-title">Autos</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="addauto.php"><i class="fa fa-briefcase"></i><span class="submenu-title">Nuevo Auto</span></a></li>
                            <li><a href="verauto.php"><i class="fa fa-th-large"></i><span class="submenu-title">Ver Auto</span></a></li>
