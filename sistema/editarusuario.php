...
<!DOCTYPE html>
<html lang="en">
<head><title>Arouesty | Editar Usuario</title>
    <meta charset="utf-8">
    ...
    <div id="wrapper"><!--BEGIN SIDEBAR MENU-->
        ...
        <div id="chat-form" class="fixed">
            ...
            <div id="chat-box" style="top:400px">
                ...
                <div class="chat-textarea"><input value="Type your message" class="form-control required required"/></div>
            </div>
        </div>
        ...
        <div id="page-wrapper"><!--BEGIN TITLE & BREADCRUMB PAGE-->
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li class="hidden"><a href="#">Usuario</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                    ...
                    <div id="sum_box" class="row mbl">
                        <div class="panel panel-violet">
                            ...
                            <div class="panel-body pan">
                                <form action="config/editarusuario.php" method="post" class="form-validate">
                                    <div class="form-body pal">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group"><label for="first-name">Dirección de correo electrónico:</label>
                                                    <div class="input-icon right"><i class="fa fa-envelope"></i><input type="text" class="form-control required" name="first-name" id="first-name" value="<?php echo $row['usuario'] ?>"></div>
                                                </div>
                                            </div>

                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="input-icon right"><label for="last-name">Contrasena:</label><input type="password" minlength="5" class="form-control required" name="contrasena" id="last-name" value="<?php echo $row['contrasena'] ?>"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="input-icon right"><label for="email-address">Nombre:</label><i class="fa fa-user"></i><input type="text" class="form-control required" name="nombre" id="email-address" value="<?php echo $row['nombre'] ?>"></div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group"><label for="phone-number">Permisos:</label>
                                                    <?php  while($row2 = $result1->fetch_assoc()) {
                                                             echo "<br><input class='form-control required' type='checkbox' name='cat[]' value='".$row2['id']."'> ".$row2['nombre']."";
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group"><label for="address">Fecha de recogida</label>
                                                    <div><span class="input-group-addon"><input type="text"  name="pickup" id="f1" class="form-control required required" value="<?php echo $row['fecha_inicio'] ?>" /></span></div>
                                                </div>
                                            </div>
