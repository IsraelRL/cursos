...
if (isset($_SESSION['name'])){
    ...
    $id=$_GET['id'];
     ...
     $sql0 = "SELECT * FROM video WHERE id='". $id."'";
    $resul0 = $conn->query($sql0);
    $row0 = $resul0->fetch_assoc();
        ...
        <div id="page-wrapper"><!--BEGIN TITLE & BREADCRUMB PAGE-->
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                <div class="page-header pull-left">
                    <div class="page-title">Nuevo Video</div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    <li><i class="fa fa-home"></i>&nbsp;<a href="home.php">Inicio</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                    <li class="hidden"><a href="#">Video</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                    <li class="active">Nuevo Video</li>
                </ol>
                <div class="clearfix"></div>
            </div>
                    ...
                    <div id="sum_box" class="row mbl">
                        <div class="panel panel-violet">
                            ...
                            <div class="panel-body pan">
                                <form action="config/editarvideo.php" method="post" class="form-validate">
                                    <div class="form-body pal">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group"><label for="first-name">Nombre:</label>
                                                    <div class="input-icon right"><input type="text" class="form-control required" name="nombre" id="first-name" value="<?php echo $row0['nombre']; ?>"></div>
                                                </div>
                                            </div>

                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="input-icon right"><label for="email-address">Frame:</label><textarea  class="form-control required" name="frame"><?php echo $row0['frame']; ?>"></textarea></div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-icon right"><label for="email-address">Categoría Seleccionada:</label>
                                                        <?php  
                                            $sql3 = "SELECT * FROM subcat WHERE id=".$row0['subcategoria'];
                                            $result3 = $conn->query($sql3);
                                            $sql4 = "SELECT * FROM subsubcat  WHERE id=".$row0['subsub'];
                                            $result4 = $conn->query($sql4);
                                           
                                            if ($row0['subcategoria']=="") {
                                            }else {
                                            $row3 = $result3->fetch_assoc();
                                            echo "<br><input class='form-control' type='checkbox' name='subcat' value='".$row3['id']."' checked> ".$row3['nombre'].'<br>'; 
                                            }
                                            if ($row0['subsub']=="") {
                                            }else {
                                            $row4 = $result4->fetch_assoc();
                                            echo "<br><input class='form-control' type='checkbox' name='subsubcat' value='".$row4['id']."'  checked> ".$row4['nombre'].'<br>'; 
                                            }
                                             
                                            echo $row3['Subcategoria'];
                                             echo $row3['subsub'];
                                            ?>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group"><label for="phone-number">Cambiar Categoría:</label>
                                            ...
                                            <div class="col-md-6">
                                            <div class="form-group">
                                                    <div class="input-icon right"><label for="email-address">Descripción:</label><input type="text" class="form-control required" name="desc" id="email-address" value="<?php echo $row0['descr']; ?>"></div>
                                            </div>
                                            </div>
                                        </div>
                                        <hr/>
