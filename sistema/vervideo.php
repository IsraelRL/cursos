...
if (isset($_SESSION['name'])){
    ...
    $sql11 = "SELECT * FROM categorias";
    $result5 = $conn->query($sql11);
                                                ...
                                                <tbody>
                                                    <?php $sql2 = "SELECT * FROM video";
                                                        ...
                                                        while ($rows = $result->fetch_assoc()){
                                                            ...
                                                            //elimina el error relacionado con la subcategoría
                                                            //hablar con isra
                                                            if(strlen($rows['subsub']) > 0){
                                                                $sql4 = "SELECT nombre FROM subsubcat WHERE id IN (".$rows['subsub'].")";
                                                                //die($sql4);
                                                                $res = $conn->query($sql4);
                                                                while ($ro = $res->fetch_assoc()){
                                                                    $x = $ro['nombre'];
                                                                ...
                                                                echo '<td>No hay subcategoría</td>';
                                                            }
                                                                

                                                        }
                                                            echo '<td>'. $rows['descr']. '</td>';
                                                            echo  "<td><a href='editarvideo.php?id=".$rows['id']."'><button type='button' class='btn btn-default btn-xs'><i class='fa fa-edit'></i>&nbsp;
                                                                Editar
                                                            </button></a>
                                                            <br>
                                                            <a href='eliminarvideo.php?id=".$rows['id']."'><button type='button' class='btn btn-danger btn-xs'><i class='fa fa-trash-o'></i>&nbsp;
                                                                Borrar
                                                            </button></a>". '</td>';                                                            
                                                        }
