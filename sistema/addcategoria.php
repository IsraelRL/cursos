...
<!DOCTYPE html>
<html lang="en">
<head><title>Arouesty | Nueva Categoria</title>
    <meta charset="utf-8">
                ...
                <div id="tab-general">
                    <div id="sum_box" class="row mbl">
                        <div class="panel panel-violet">
                            <div class="panel-heading">Ingresar Categoria</div>
                            <div class="panel-body pan">
                                <form action="config/ingresacat.php" method="post" class="form-validate">
