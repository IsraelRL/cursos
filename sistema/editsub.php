        ...
        <div id="page-wrapper"><!--BEGIN TITLE & BREADCRUMB PAGE-->
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                <div class="page-header pull-left">
                    <div class="page-title">Categoria</div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li class="active">Nueva Sub Categoria</li>
                </ol>
                <div class="clearfix"></div>
            </div>
                    ...
                    <div id="sum_box" class="row mbl">
                        <div class="panel panel-violet">
                            ...
                            <div class="panel-body pan">
                                <form action="config/editsubcat.php" method="post" class="form-validate">
                                    <div class="form-body pal">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group"><label for="first-name">Nombre</label>
                                                    <div class="input-icon right"><input type="text" class="form-control required" name="nombre" id="first-name" value="<?php echo $row1['nombre']; ?>"></div>
                                                    <input type="hidden" name="id" value="<?php echo $id; ?>">
                                                    <input type="hidden" name="id" value="<?php $row1['categoria']; ?>">
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-actions text-right pal">
                                        ...
                                        <?php echo "<a href='config/eliminarsub.php?id=".$row1['id']."'><button type='button' class='btn btn-danger btn-xl'><i class='fa fa-trash-o'></i>&nbsp;
                                                            Borrar
                                                        </button></a>"; ?>
                                    </div>
                                </form>
