...
<!DOCTYPE html>
<html lang="en">
<head><title>Arouesty | Nueva Sub Categoria</title>
    <meta charset="utf-8">
...
container.innerHTML = '<?php $sql2 = "SELECT * FROM subcat WHERE categoria=2"; $result = $conn->query($sql2);  while ($rows = $result->fetch_assoc()){ ?><input class="required" required type="radio" name="subcat" value="<?php echo $rows['id']; ?>"> <?php echo $rows['nombre']; } ?> ';
} else if (obj[ obj.selectedIndex ].value == 3 ) {
container.innerHTML = '<?php $sql2 = "SELECT * FROM subcat WHERE categoria=3"; $result = $conn->query($sql2);  while ($rows = $result->fetch_assoc()){ ?><input class="required" required type="radio" name="subcat" value="<?php echo $rows['id']; ?>"> <?php echo $rows['nombre']. "<br>"; } ?> ';}else if (obj[ obj.selectedIndex ].value == 4 ) {
container.innerHTML = '<?php $sql2 = "SELECT * FROM subcat WHERE categoria=4"; $result = $conn->query($sql2);  while ($rows = $result->fetch_assoc()){ ?><input class="required" required type="radio" name="subcat" value="<?php echo $rows['id']; ?>"> <?php echo $rows['nombre']. "<br>"; } ?> ';}
else if (obj[ obj.selectedIndex ].value == 5 ) {
container.innerHTML = '<?php $sql2 = "SELECT * FROM subcat WHERE categoria=5"; $result = $conn->query($sql2);  while ($rows = $result->fetch_assoc()){ ?><input class="required" required type="radio" name="subcat" value="<?php echo $rows['id']; ?>"> <?php echo $rows['nombre']. "<br>"; } ?> ';}
else if (obj[ obj.selectedIndex ].value == 6 ) {
container.innerHTML = '<?php $sql2 = "SELECT * FROM subcat WHERE categoria=6"; $result = $conn->query($sql2);  while ($rows = $result->fetch_assoc()){ ?><input class="required" required type="radio" name="subcat" value="<?php echo $rows['id']; ?>"> <?php echo $rows['nombre']. "<br>"; } ?> ';}
else if (obj[ obj.selectedIndex ].value == 7 ) {
container.innerHTML = '<?php $sql2 = "SELECT * FROM subcat WHERE categoria=7"; $result = $conn->query($sql2);  while ($rows = $result->fetch_assoc()){ ?><input class="required" required type="radio" name="subcat" value="<?php echo $rows['id']; ?>"> <?php echo $rows['nombre']. "<br>"; } ?> ';}
else if (obj[ obj.selectedIndex ].value == 8 ) {
container.innerHTML = '<?php $sql2 = "SELECT * FROM subcat WHERE categoria=8"; $result = $conn->query($sql2);  while ($rows = $result->fetch_assoc()){ ?><input class="required" required type="radio" name="subcat" value="<?php echo $rows['id']; ?>"> <?php echo $rows['nombre']. "<br>"; } ?> ';}
                ...
                <div id="tab-general">
                    <div id="sum_box" class="row mbl">
                        <div class="panel panel-violet">
                            <div class="panel-heading">Nueva Sub Categoria</div>
                            <div class="panel-body pan">
                                <form action="config/ingresasubcat2.php" method="post" class="form-validate">
                                    <div class="form-body pal">
                                        <div class="row">
                                        <div class="col-md-6">
                                           
                                                <div class="form-group"><label for="phone-number">Categoria:</label>
                                                <select class="form-control required" name="subcat" onchange="mostrar(this,1)";> 
                                                <option value="">Selecciona una Categoría</option>
                                                     
                                                    <?php  while ($rows = $res->fetch_assoc()){
                                                             echo "<option value=''>" .$rows['nombre']."</b></option>";
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group"><label for="first-name">Nombre</label>
                                                    <div class="input-icon right"><input type="text" class="form-control required" name="nombre" id="first-name" placeholder="Nombre de la categoria"></div>
                                                </div>
                                            </div>
