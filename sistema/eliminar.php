...
<!DOCTYPE html>
<html lang="en">
<head><title>CityCar | Eliminar Reservaciones</title>
    <meta charset="utf-8">
                ...
                <div id="tab-general">
                    <div id="sum_box" class="row mbl">
                        <table class="table table-hover table-striped table-bordered table-advanced tablesorter">
                                                ...
                                                <?php  echo "<a href='config/eliminar.php?id=".$id."'><button type='button' class='btn btn-danger btn-xs'><i class='fa fa-trash-o'></i>&nbsp;
                                                            Borrar
                                                        </button></a>";?>
                    </div>
