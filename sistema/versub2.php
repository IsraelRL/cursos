            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li><a href="#"><i class="fa fa-bar-chart-o fa-fw">
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="#"><i class="fa fa-angle-right"></i><span class="submenu-title">Ver Categoría</span></a></li>
        ...
        <div id="page-wrapper"><!--BEGIN TITLE & BREADCRUMB PAGE-->
            ...
            <div class="portlet box portlet-yellow">
                            <div class="portlet-header">
                                <div class="caption">Ver Usuarios</div>
                            </div>
                        ...
                        <table class="table table-hover table-striped table-bordered table-advanced tablesorter">
                                                ...
                                                <tbody>
                                                    <?php 
                                                     ...
                                                     $sql4 = "SELECT nombre FROM subcat WHERE id IN (".$rows['subcat'].")";
                                                    $res = $conn->query($sql4);
                                                   ...
                                                   echo '<td>'.$cat. '</td>';
                                                      echo ' <td><a class="dropdown-item" onclick="Confirm('.$rows['id'].')" href="#"><button type="button" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>&nbsp;
                                                            Borrar
                                                        </button></a></td>';
