...
if (isset($_SESSION['name'])){
    ...
    $id=$_GET['id'];
     ...
     $sql0 = "SELECT * FROM subsubcat WHERE id='". $id."'";
    $resul0 = $conn->query($sql0);
    $row0 = $resul0->fetch_assoc();
    $sql2 = "SELECT * FROM subcat WHERE id='".$row0['subcat']."'";
                ...
                <div id="tab-general">
                    <div id="sum_box" class="row mbl">
                        <div class="panel panel-violet">
                            <div class="panel-heading">Editar Sub Categoria</div>
                            <div class="panel-body pan">
                                <form action="config/editsubsubcat.php" method="post" class="form-validate">
                                    <div class="form-body pal">
                                        <div class="row">
                                        <div class="col-md-6">
                                                <div class="form-group"><label for="phone-number">Sub Categoria:</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group"><label for="first-name">Nombre</label>
                                                    <div class="input-icon right"><input type="text" class="form-control required" name="nombre" id="first-name" value="<?php echo $row0['nombre']; ?>">
                                                    <input type="hidden" class="form-control required" name="id" id="first-name" value="<?php echo $row0['id']; ?>">
                                                    </div>
                                                </div>
                                            </div>
