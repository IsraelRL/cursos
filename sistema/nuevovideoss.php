...
if (isset($_SESSION['name'])){
    ...
    $id=$_GET['id'];
     ...
     $sql0 = "SELECT * FROM subcat WHERE id='". $id."'";
                                ...
                                <form action="config/ingresavideo.php" method="post" class="form-validate">
                                    <div class="form-body pal">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group"><label for="first-name">Nombre:</label>
                                                    <div class="input-icon right"><input type="text" class="form-control required" name="nombre" id="first-name"></div>
                                                </div>
                                            </div>

                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="input-icon right"><label for="email-address">Frame:</label><textarea  class="form-control required" name="frame"></textarea></div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-icon right"><label for="email-address">Categoría Seleccionada:</label>
                                                        <?php  
                                            $sql3 = "SELECT * FROM subsubcat WHERE id=".$id;
                                            $result3 = $conn->query($sql3);
                                            
                                            
                                            $row3 = $result3->fetch_assoc();
                                            echo "<br><input class='form-control' type='radio' name='subsubcat' value='".$row3['id']."' checked> ".$row3['nombre'].'<br>'; 
                                            ...
                                            <div class="col-md-6">
                                            <div class="form-group">
                                                    <div class="input-icon right"><label for="email-address">Descripción:</label><input type="text" class="form-control required" name="desc" id="email-address"></div>
                                            </div>
                                            </div>
                                        </div>
                                        <hr/>
