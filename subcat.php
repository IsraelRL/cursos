...
if (isset($_SESSION['name'])){
	...
	$sql1 = "SELECT * FROM subcat WHERE id=".$id;
	    					...
	    					<div class=".about-content">
	    						<div class="mimenu mimenublack fuentes1">
	    							...
	    							<h5 style="letter-spacing: .110em;">
	    								...
	    								?></b></span><span class="fa arrow"></h5>

	    								<?php 

	    								$sql5 = "SELECT * FROM subsubcat WHERE subcat= '".$id."'";
	    								...
	    								<?php
	    								$sql3 = "SELECT * FROM video WHERE subcategoria = ".$id; 
	    								$result2 = $conn->query($sql3);
	    								while ($rows = $result2->fetch_assoc()){ ?>
	    								<?php echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='video.php?id=".$rows['id']."&subcat=".$id ."'>"; ?><span class="submenu-title"></span><img src="img/ico.png" width="10"> <?php
    ...
    <section class="ls page_copyright section_padding_20">
    	<div class="container">
    		<div class="row topmargin_5 bottommargin_5">
    			<div class="col-sm-12 text-center">
    				<p class="darklinks">&copy; Arouesty 2017 | Derechos Reservados</p>
    			</div>
    		</div>
    	</div>
    </section>
