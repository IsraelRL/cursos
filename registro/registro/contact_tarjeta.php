                ...
                <div class="col-lg-8 col-lg-offset-2">
                  ...
                  <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <input type="text" size="20" name='name' value="<?php echo $_SESSION['todos']['name']; ?>" class="input7" data-conekta="card[name]">
                                    </div>
                                </div>
                            </div>
                  ...
                  <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <input type="text" size="20" class="input8" data-conekta="card[number]">
                                    </div>
                                </div>                            
                            </div>
                  ...
                  <div class="col-md-10">
                                    <div class="form-group" class="col-md-3">
                                        ...
                                        <select class="input9" data-conekta="card[exp_month]">
                                            <?php for ($i=1; $i <= 12; $i++) { 
                                                $mes = "".$i;
                                                if($i < 10){
                                                    $mes = "0".$i;
                                        ...
                                        </select><select class="input9" data-conekta="card[exp_year]">
                                            <?php
                                                $thisyear = date("Y");
                  ...
                  <div class="col-md-10">
                                    <div class="form-group">
                                        <label>CVC </label>
                                        <input type="text" size="4" class="input10" maxlength="3" data-conekta="card[cvc]"><br><small>(tres últimos dígitos del reverso de la tarjeta)</small>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                  ...
                                  <input type="image" src="../img/completar.jpg"  style="font-weight: bold;" value="COMPLETAR PEDIDO" />
                                  </p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <br>
                                    <img src="../lib/ssl.png" style="max-width: 100%; padding: 15px; text-align: center;" width="15%">
                                    <br>
                                    <small>
                                        <ul>
